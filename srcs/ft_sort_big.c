...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/16 01:20:52 by edupless          #+#    #+#             */
/*   Updated: 2023/05/19 15:33:34 by edupless         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ft_sort_b_till_3(t_stack **stack_a, t_stack **stack_b)
{
	...
	while (ft_lstsize2(*stack_a) > 3 && !ft_checksorted(*stack_a))
	{
		int i = ft_rotate_type_ab(*stack_a, *stack_b);
		while (i >= 0)
		{
...
t_stack	*ft_sort_b(t_stack **stack_a)
{
	...
	stack_b = NULL;
	if (ft_lstsize2(*stack_a) > 3 && !ft_checksorted(*stack_a))
...
void	ft_sort(t_stack **stack_a)
{
	...
	else
	{
		...
		i = ft_trouver_i (*stack_a, ft_min(*stack_a));
